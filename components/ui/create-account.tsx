...
export const CreateAccountPage: React.FC<CreateAccountPageProps> = ({
  ...
  description = 'Join us today and start managing your invoices efficiently',
  heroImageSrc,
  testimonials = [],
  onCreateAccount,
  onGoogleSignUp,
            ...
            <form className="space-y-5" onSubmit={onCreateAccount}>
              ...
              <div className="animate-element animate-delay-700">
                <label className="flex items-center gap-3 cursor-pointer text-sm">
                  <input type="checkbox" name="agreeToTerms" className="custom-checkbox" suppressHydrationWarning required />
